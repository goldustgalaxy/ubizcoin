...
#ifndef UbizCoin_ZUTCWALLET_H
#define UbizCoin_ZUTCWALLET_H
...
public:
    CzUTCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZUTC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZUTC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
