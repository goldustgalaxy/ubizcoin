...
#ifndef UbizCoin_ZUTCTRACKER_H
#define UbizCoin_ZUTCTRACKER_H
...
public:
    CzUTCTracker(std::string strWalletFile);
    ~CzUTCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzUTCWallet* zUTCWallet = NULL);
