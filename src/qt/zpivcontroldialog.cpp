// Copyright (c) 2017-2020 The UbizCoin developers
    ...
    model(0)
{
    ...
    // Title
    ui->labelTitle->setText(tr("Select zUTC Denominations to Spend"));
    ...
    for (const CMintMeta& mint : setMints) {
        ...
        if(!fSpendable) {
            ...
            if(nConfirmations < Params().Zerocoin_MintRequiredConfirmations())
                ...
                strReason = "Your wallet is locked. Impossible to spend zUTC.";
            else if (!mint.isSeedCorrect)
                strReason = "The zUTC seed used to mint this zUTC is not the same as currently hold in the wallet";
            else
