...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Ubizcoin [UTC]"),
     ...
     * override -datadir in the ubizcoin.conf file in the default data directory
     * (to be consistent with ubizcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
