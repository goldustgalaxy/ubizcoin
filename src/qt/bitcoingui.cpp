                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Ubizcoin [UTC]") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Ubizcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ubizcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zUTC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Ubizcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Ubizcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Ubizcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Ubizcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Ubizcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Ubizcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Ubizcoin Core help message to get a list with possible Ubizcoin command-line options"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Ubizcoin network", "", count));
}
...
{
    QString strTitle = tr("Ubizcoin [UTC]"); // default title
