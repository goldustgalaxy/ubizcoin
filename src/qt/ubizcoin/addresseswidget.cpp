...
#include "qt/ubizcoin/forms/ui_addresseswidget.h"
#include "qt/ubizcoin/addresslabelrow.h"
#include "qt/ubizcoin/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(UbizCoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter UbizCoin address"));
