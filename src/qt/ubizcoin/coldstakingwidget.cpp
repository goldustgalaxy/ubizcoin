...
#include "qt/ubizcoin/coldstakingwidget.h"
#include "qt/ubizcoin/forms/ui_coldstakingwidget.h"
#include "qt/ubizcoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/ubizcoin/requestdialog.h"
#include "qt/ubizcoin/tooltipmenu.h"
#include "qt/ubizcoin/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(UbizCoinGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your UTCs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept UTC delegation / Delegate UTC"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select UTC outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 UTC" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
