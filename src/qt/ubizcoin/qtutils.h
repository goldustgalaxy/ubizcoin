...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, UbizCoinGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, UbizCoinGUI *gui, double posX = 3);
