...
#include "qt/ubizcoin/coincontrolpivwidget.h"
#include "qt/ubizcoin/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select UTC Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("UTC");
    ...
    ui->labelValueAfter->setText("0.00 UTC");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 UTC");
    ui->labelValueFee->setText("0.00 UTC");
