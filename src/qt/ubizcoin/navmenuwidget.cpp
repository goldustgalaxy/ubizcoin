...
#include "qt/ubizcoin/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(UbizCoinGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    setCssProperty(ui->imgLogo, "img-nav-logo-ubizcoin");
