...
#include "qt/ubizcoin/forms/ui_dashboardwidget.h"
#include "qt/ubizcoin/sendconfirmdialog.h"
#include "qt/ubizcoin/txrow.h"
...
DashboardWidget::DashboardWidget(UbizCoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of UTC staked."));
    ...
    ui->labelAmountPiv->setText("0 UTC");
    ...
    ui->btnHowTo->setText(tr("How to get UTC"));
...
const QMap<int, std::pair<qint64, qint64>> DashboardWidget::getAmountBy() {
    ...
    for (int i = 0; i < size; ++i) {
        ...
        bool isPiv = modelIndex.data(TransactionTableModel::TypeRole).toInt() != TransactionRecord::StakeZUTC;
...
bool DashboardWidget::loadChartData(bool withMonthNames) {
    ...
    chartData->amountsByCache = getAmountBy(); // pair UTC, zUTC
...
void DashboardWidget::onChartRefreshed() {
    ...
    // init sets
    set0 = new QBarSet("UTC");
    set1 = new QBarSet("zUTC");
