...
#ifndef UbizCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define UbizCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //UbizCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
