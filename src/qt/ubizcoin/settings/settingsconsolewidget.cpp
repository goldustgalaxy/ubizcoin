...
#include "qt/ubizcoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/ubizcoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(UbizCoinGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(){
    ...
    message(CMD_REPLY, (tr("Welcome to the UbizCoin RPC console.") + "<br>" +
