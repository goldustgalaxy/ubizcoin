...
#include "qt/ubizcoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/ubizcoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(UbizCoinGUI* _window, QWidget *parent) :
