...
#include "qt/ubizcoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/ubizcoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(UbizCoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to UbizCoinGUI::handleRestart()
