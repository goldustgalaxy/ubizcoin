...
#include "qt/ubizcoin/settings/settingsnetworkwidget.h"
#include "qt/ubizcoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/ubizcoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(UbizCoinGUI* _window, QWidget *parent) :
