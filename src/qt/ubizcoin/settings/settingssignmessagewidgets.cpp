...
#include "qt/ubizcoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(UbizCoinGUI* _window, QWidget *parent) :
