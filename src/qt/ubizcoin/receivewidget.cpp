...
#include "qt/ubizcoin/forms/ui_receivewidget.h"
...
#include "qt/ubizcoin/addressholder.h"
...
ReceiveWidget::ReceiveWidget(UbizCoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive UTC."));
