...
#include "qt/ubizcoin/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/ubizcoin/lockunlock.h"
#include "qt/ubizcoin/qtutils.h"
#include "qt/ubizcoin/receivedialog.h"
...
TopBar::TopBar(UbizCoinGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("UbizCoin")
    updateDisplayUnit();
