...
/** Utility functions used by the Ubizcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Ubizcoin addresses in monospace font
...
// Parse "ubizcoin:" URI into recipient object, return true on successful parsing
