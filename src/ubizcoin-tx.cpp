...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Ubizcoin Core ubizcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ubizcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ubizcoin transaction") + "\n" +
                               "  ubizcoin-tx [options] -create [commands]   " + _("Create hex-encoded ubizcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ubizcoin transaction
