...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Ubizcoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Ubizcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Ubizcoin features */
        {"ubizcoin", "masternode", &masternode, true, true, false},
        {"ubizcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"ubizcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ubizcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ubizcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ubizcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"ubizcoin", "startmasternode", &startmasternode, true, true, false},
        {"ubizcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ubizcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ubizcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ubizcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ubizcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ubizcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ubizcoin", "mnbudget", &mnbudget, true, true, false},
        {"ubizcoin", "preparebudget", &preparebudget, true, true, false},
        {"ubizcoin", "submitbudget", &submitbudget, true, true, false},
        {"ubizcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ubizcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ubizcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ubizcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ubizcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ubizcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ubizcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ubizcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"ubizcoin", "mnsync", &mnsync, true, true, false},
        {"ubizcoin", "spork", &spork, true, true, false},
        {"ubizcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ubizcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ubizcoind, or the -server option to ubizcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ubizcoin-cli " + methodname + " " + args + "\n";
}
