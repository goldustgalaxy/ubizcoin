...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04480f281c31f9c9a42acdb67fd131cb7dd92b66b554dc78c11c1b373a6bfeebf46692bbc9040e204eec4e48de7832af4fac15d5506b27e80a5d59e788837f285b");
        nDefaultPort = 30130;
       bnProofOfWorkLimit = ~uint256(0) >> 20;
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04d1423ecec159bf63e4aa21fb5b0aa348a9fcd346dcb73c522848e4d1e9262970f074998d461fc616b9eca4cb748bf322d138fde105308f4312e7d115c18c0e18") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1622938352;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1054795;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // UbizCoin: 1 day
        nTargetSpacing = 1 * 60;  // UbizCoin: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testnet.utc.io", "testnet.utc.io"));         // Single node address
        vSeeds.push_back(CDNSSeedData("testnet1.utc.io", "testnet1.utc.io"));       // Single node address
        vSeeds.push_back(CDNSSeedData("testnet.ubizcoincoin.org", "testnet.ubizcoincoin.org"));       // Single node address


        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet ubizcoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet ubizcoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet ubizcoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet ubizcoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet ubizcoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // UbizCoin: 1 day
        nTargetSpacing = 1 * 60;        // UbizCoin: 1 minutes
