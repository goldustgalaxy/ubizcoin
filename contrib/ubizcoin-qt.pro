...
RESOURCES += src/qt/ubizcoin.qrc src/qt/ubizcoin_locale.qrc

TRANSLATIONS += src/qt/locale/ubizcoin_bg.ts \
                src/qt/locale/ubizcoin_de.ts \
                src/qt/locale/ubizcoin_en.ts \
                src/qt/locale/ubizcoin_es.ts \
                src/qt/locale/ubizcoin_fi.ts \
                src/qt/locale/ubizcoin_fr.ts \
                src/qt/locale/ubizcoin_it.ts \
                src/qt/locale/ubizcoin_ja.ts \
                src/qt/locale/ubizcoin_pl.ts \
                src/qt/locale/ubizcoin_pt.ts \
                src/qt/locale/ubizcoin_ru.ts \
                src/qt/locale/ubizcoin_sk.ts \
                src/qt/locale/ubizcoin_sv.ts \
                src/qt/locale/ubizcoin_vi.ts \
                src/qt/locale/ubizcoin_zh_CN.ts \
                src/qt/locale/ubizcoin_zh_TW.ts
