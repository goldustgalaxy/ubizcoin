...
class RawTransactionsTest(UbizCoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid ubizcoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid ubizcoin address" in e.error['message'])
