...
from test_framework.ubizcoin_node import UbizCoinTestNode
...
class UbizCoin_ColdStakingTest(UbizCoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(UbizCoinTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, None, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 UTC from the pot)
