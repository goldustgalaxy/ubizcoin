Contributing to Ubizcoin Core
============================

The Ubizcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Ubizcoin Core project, and is not to be
confused with overall Ubizcoin Network Protocol consensus changes.

Whether a pull request is merged into Ubizcoin Core rests with the project merge
...
Patches that change Ubizcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Ubizcoin consensus, it must have been
...
The project leader is the release manager for each Ubizcoin Core release.
