...
The build script we'll be using is contained in the UbizCoin github repository ([contrib/gitian-build.py](https://github.com/ubizcoin-project/ubizcoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the UbizCoin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/UbizCoin-Project/UbizCoin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, ubizcoin-detached-sigs, and ubizcoin GitHub repos.
