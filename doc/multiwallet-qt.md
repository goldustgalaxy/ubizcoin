...
In order to support loading of multiple wallets in ubizcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ubizcoin.cpp.
...
Changes to ubizcoin.cpp
----------------------
ubizcoin.cpp is the entry point into ubizcoin-qt, and as such, will require some minor modifications to provide hooks for
